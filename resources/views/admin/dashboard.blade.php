        ...
        <div class="card card-stats">
            ...
            <div class="card-footer">
                <div class="stats">
                    ...
                    <a href="{{route('user.index')}}" class="warning-link">Get All Members...</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-6 col-md-12">
        <div class="card">
            <div class="card-header card-header-primary">
                <h4 class="card-title">The latest users</h4>
                <p class="card-category">Update at {{$theCurrentDate}}</p>
            </div>
            <div class="card-body table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        @foreach ($theLatestusers as $theLatestuser)
                        <tr>
                            <td></td>
                            <td>{{$theLatestuser->name}}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
